...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://qfyymlaomnldgxmwwmam.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_ULcSFcNLZGay1b2bzY2j8w_B9xazCFy';
...
@media (max-width: 480px) {
  .topbar { padding-left: max(10px, env(safe-area-inset-left)); padding-right: max(10px, env(safe-area-inset-right)); gap: 10px; }
